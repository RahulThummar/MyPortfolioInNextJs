        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white border border-border p-8 rounded-3xl shadow-xl flex flex-col gap-6">
                <div className="flex items-center gap-6">
                  <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-primary/20 shadow-md relative bg-section flex items-center justify-center">
                    <Image src="/images/mpic.jpg" alt="Rahul Thummar" fill className="object-cover" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-text-primary">Rahul Thummar</h3>
              ...
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat, index) => (
                  <motion.div
                    ...
                    className="bg-section p-6 rounded-2xl border border-border text-center hover:border-primary/30 transition-colors"
                  >
